...
async def mailing(message: types.Message, state: FSMContext):
    ...
    if text == 'exit':
        ...
        await message.answer(f'Рассылка выполнена успешно, сообщение было отправлено {count_of_users} пользователям')
        await message.answer('Чтобы создать новую рассылку воспользуйтесь командой /all')
